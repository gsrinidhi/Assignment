...
#define PIXXEL_CONTROLLER_CR_PIPE_ERR_EID 9
#define PIXXEL_CONTROLLER_READ_ERR_EID 10
#define PIXXEL_CONTROLLER_OPEN_ERR_EID 11
#define PIXXEL_CONTROLLER_PIPE_ERR_EID      7
