...
#include "pixxel_controller_internal_cfg_values.h"
...
#define PIXXEL_CONTROLLER_PLATFORM_PIPE_DEPTH         PIXXEL_CONTROLLER_PLATFORM_CFGVAL(PIPE_DEPTH)
#define DEFAULT_PIXXEL_CONTROLLER_PLATFORM_PIPE_DEPTH 32 /* Depth of the Command Pipe for Application */

#define PIXXEL_CONTROLLER_PLATFORM_PIPE_NAME         PIXXEL_CONTROLLER_PLATFORM_CFGVAL(PIPE_NAME)
#define DEFAULT_PIXXEL_CONTROLLER_PLATFORM_PIPE_NAME "PIXXEL_CONTROLLER_CMD_PIPE"

#define PIXXEL_CONTROLLER_PLATFORM_NUMBER_OF_TABLES         PIXXEL_CONTROLLER_PLATFORM_CFGVAL(NUMBER_OF_TABLES)
#define DEFAULT_PIXXEL_CONTROLLER_PLATFORM_NUMBER_OF_TABLES 1 /* Number of Example Table(s) */

#define PIXXEL_CONTROLLER_PLATFORM_TABLE_OUT_OF_RANGE_ERR_CODE         PIXXEL_CONTROLLER_PLATFORM_CFGVAL(TABLE_OUT_OF_RANGE_ERR_CODE)
#define DEFAULT_PIXXEL_CONTROLLER_PLATFORM_TABLE_OUT_OF_RANGE_ERR_CODE -1

#define PIXXEL_CONTROLLER_PLATFORM_TBL_ELEMENT_1_MAX         PIXXEL_CONTROLLER_PLATFORM_CFGVAL(TBL_ELEMENT_1_MAX)
#define DEFAULT_PIXXEL_CONTROLLER_PLATFORM_TBL_ELEMENT_1_MAX 10

#define PIXXEL_CONTROLLER_PLATFORM_TABLE_FILE         PIXXEL_CONTROLLER_PLATFORM_CFGVAL(TABLE_FILE)
#define DEFAULT_PIXXEL_CONTROLLER_PLATFORM_TABLE_FILE "/cf/pixxel_controller_tbl.tbl"
