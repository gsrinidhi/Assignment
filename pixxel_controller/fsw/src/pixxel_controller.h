...
#ifndef PIXXEL_CONTROLLER_H
#define PIXXEL_CONTROLLER_H
...
#include "pixxel_controller_platform_cfg.h"

#include "pixxel_controller_perfids.h"
...
typedef struct
{
    ...
    */
    PIXXEL_CONTROLLER_DisplayParamTlm_t DevReadBuf,DevWriteAck;
...
*/
extern PIXXEL_CONTROLLER_Data_t PIXXEL_CONTROLLER_Data;
...
**
** Note: Except for the entry point (PIXXEL_CONTROLLER_Main), these
**       functions are not called from any other source module.
*/
void         PIXXEL_CTR_Main(void);
CFE_Status_t PIXXEL_CONTROLLER_Init(void);

#endif /* PIXXEL_CONTROLLER_H */
