 ...
 *   are defined in pixxel_controller_msgdefs.h.
 */
...
{
    CFE_MSG_CommandHeader_t CommandHeader;
    PIXXEL_CONTROLLER_DisplayParam_Payload_t Payload;
} PIXXEL_CONTROLLER_DEV_WRITE_t;
...
{
    CFE_MSG_TelemetryHeader_t  TelemetryHeader; /**< \brief Telemetry header */
    PIXXEL_CONTROLLER_DisplayParam_Payload_t Payload;         /**< \brief Telemetry payload */
} PIXXEL_CONTROLLER_DisplayParamTlm_t;
